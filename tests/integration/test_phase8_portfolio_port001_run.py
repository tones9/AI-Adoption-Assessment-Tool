...
def test_port001_output_bundle_is_hash_frozen() -> None:
...
def test_port001_candidate_is_schema_valid_and_evidence_resolves() -> None:
...
def test_port001_approval_assessment_and_package_are_complete() -> None:
...
def test_port001_sqlite_lineage_is_exact_and_integrity_valid() -> None:
...
def test_port001_after_packet_was_still_sealed_at_output_freeze() -> None:
    manifest = json.loads((RUN / "output_freeze_manifest.v0.1.json").read_text())
